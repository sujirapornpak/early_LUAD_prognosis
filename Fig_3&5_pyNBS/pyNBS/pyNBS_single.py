...
def NBS_single(sm_mat, regNet_glap, propNet=None, propNet_kernel=None, 
    ...
    pats_subsample_p, gene_subsample_p, min_muts = 0.8, 0.8, 1 # default min_muts = 10
    ...
    # Subsample Data
    sm_mat_subsample = core.subsample_sm_mat(sm_mat, propNet=propNet, pats_subsample_p=pats_subsample_p, gene_subsample_p=gene_subsample_p, min_muts=min_muts)
    if verbose:
